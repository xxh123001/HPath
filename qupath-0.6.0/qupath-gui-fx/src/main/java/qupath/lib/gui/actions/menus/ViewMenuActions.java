...
public class ViewMenuActions implements MenuActions {
	...
	public class Actions {
		...
		@ActionConfig("Action.View.multiChannelOverlay")
		public final Action MULTI_CHANNEL_OVERLAY = createAction(() -> new qupath.lib.gui.commands.MultiChannelOverlayCommand(qupath).run());
		
		@ActionConfig("Action.View.hierarchicalChannels")
		public final Action HIERARCHICAL_CHANNELS = createAction(() -> new qupath.lib.gui.commands.ShowHierarchicalChannelsPaneCommand(qupath).run());
