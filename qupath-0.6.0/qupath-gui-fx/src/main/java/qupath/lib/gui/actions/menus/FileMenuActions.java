...
import qupath.lib.gui.commands.ExportFullImageWithAnnotationsCommand;
...
public class FileMenuActions implements MenuActions {
	...
	public class ProjectActions {
		...
		public final Action SEP_23 = ActionTools.createSeparator();
		
		@ActionConfig("Action.File.Project.merger")
		public final Action PROJECT_MERGER = createAction(() -> Commands.showProjectMerger(qupath));
	...
	public class ExportImageActions {
		...
		@ActionConfig("Action.File.ExportImage.fullWithAnnotations")
		public final Action EXPORT_FULL_WITH_ANNOTATIONS = qupath.createImageDataAction(imageData -> 
			new ExportFullImageWithAnnotationsCommand(qupath).run());
