...
public class ObjectsMenuActions implements MenuActions {
	...
	public class AnnotationActions {
		...
		@ActionConfig("Action.Objects.Annotation.navigator")
		public final Action ANNOTATION_NAVIGATOR = new Action(e -> Commands.showAnnotationNavigator(qupath));
		
		public final Action SEP_10 = ActionTools.createSeparator();
		
		@ActionConfig("Action.Objects.Convert.annotationsToDetections")
		public final Action CONVERT_ANNOTATIONS_TO_DETECTIONS = qupath.createImageDataAction(imageData -> Commands.convertAnnotationsToDetections(imageData));
		
		@ActionConfig("Action.Objects.Convert.detectionsToAnnotations")
		public final Action CONVERT_DETECTIONS_TO_ANNOTATIONS = qupath.createImageDataAction(imageData -> Commands.convertDetectionsToAnnotations(imageData));
		
		@ActionConfig("Action.Objects.Convert.allAnnotationsToDetections")
		public final Action CONVERT_ALL_ANNOTATIONS_TO_DETECTIONS = qupath.createImageDataAction(imageData -> Commands.convertAllAnnotationsToDetections(imageData));
		
		@ActionConfig("Action.Objects.Convert.allDetectionsToAnnotations")
		public final Action CONVERT_ALL_DETECTIONS_TO_ANNOTATIONS = qupath.createImageDataAction(imageData -> Commands.convertAllDetectionsToAnnotations(imageData));
